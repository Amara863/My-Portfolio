    ...
    <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', minHeight: '100vh', background: '#05070f', color: '#e8edf5', fontFamily: 'sans-serif' }}>
      <style>{`
        * { box-sizing: border-box; }
        .sidebar { background: #080c18; border-right: 1px solid rgba(255,255,255,0.06); padding: 2rem 1.5rem; }
        .logo { font-family: 'Syne',sans-serif; font-size: 1.3rem; font-weight: 800; margin-bottom: 2rem; }
        .logo span { color: #00e5c3; }
        .nav-item { padding: .7rem 1rem; border-radius: 8px; font-size: .88rem; color: #8b9ab5; cursor: pointer; display: flex; align-items: center; gap: .7rem; }
        .nav-item.active { background: rgba(0,229,195,0.08); color: #00e5c3; }
        ...
        .stat { background: #0e1525; border: 1px solid rgba(255,255,255,0.06); border-radius: 14px; padding: 1.5rem; }
        ...
        .empty { text-align: center; padding: 3rem; color: #3d4f6b; font-family: monospace; }
      ...
      <div className="sidebar">
        <div className="sidebar-inner">
          ...
          <div className="nav-items">
            <div className="nav-item active">📬 Messages</div>
